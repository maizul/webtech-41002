...
<tr>
  <td>Post</td>
  <td>:</td> 
  <td><textarea name="poststat" rows="4" cols="50" id="poststat" onkeyup="emptyPost()" value="poststat" placeholder="Type something"></textarea></td>
  <td><span class="error" id="poststatErr">* <?php echo $poststatErr;?></span></td>
</tr>
<tr>
